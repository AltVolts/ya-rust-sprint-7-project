...
export const ORACLE_PROGRAM_ID = "GPGNDxiv1RPttXyJFkLZq93FCnRSehTuKaSoKSa5UwSP";
export const MINTER_PROGRAM_ID = "AaTanmwwcwHzRQEdWjLqnC4ikRz8EebL2Wx8Wd5y6EGQ";
